...
const Home = () => {
    ...
    useEffect(() => {
        fetch('http://localhost:5000/blogs/dateSorted', {
            method: 'GET'
        })
            .then(res => res.json())
    ...
    return (
        <div className="container mx-auto space-y-10">
            <Carousel autoplay className="custom-slider rounded-lg max-h-36 md:max-h-52 lg:max-h-max">
                <div>
                    <h2 className='lg:text-7xl text-4xl font-black w-full h-full flex justify-end items-center bg-cover bg-no-repeat pr-10 md:pr-32 font-serif' style={{ backgroundImage: 'url(https://i.ibb.co/C1p3wT9/52257.jpg)' }}>Blog<br /><br /><br /><span>Stream</span></h2>
                </div>
                <div>
	...
	<div className="container mx-auto flex flex-col justify-around p-4 text-center md:p-10 lg:flex-row">
		<div className="flex flex-col justify-center lg:text-left">
			<p className="mb-1 text-sm font-medium tracking-widest uppercase dark:text-violet-600">Read blogs with our app</p>
			<h1 className="py-2 text-3xl font-medium leading-tight title-font">Enter The Realm Of Knowledge.</h1>
		</div>
