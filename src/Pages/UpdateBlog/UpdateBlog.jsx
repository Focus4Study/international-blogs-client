                ...
                <form onSubmit={handleUpdateBlog} className="container flex flex-col mx-auto space-y-12  mb-20">
                    <div className="grid grid-cols-2 gap-10 mt-20">
                        ...
                        <div>
                            ...
                            <input name="title" id="title" type="text" placeholder="Title" className="input input-bordered w-full mt-3 focus:ring focus:ring-opacity-75 dark:text-gray-50 focus:dark:ring-violet-600 dark:border-gray-300" />
                        </div>

                        <div>
                            <label htmlFor="User Name" className="text-xl font-bold mr-5">User Name</label>
                            <input name="name" id="user_name" type="text" placeholder="User Name" className="input input-bordered w-full mt-3 focus:ring focus:ring-opacity-75 dark:text-gray-50 focus:dark:ring-violet-600 dark:border-gray-300" />
                        </div>

                        <div>
                            <label htmlFor="User Email" className="text-xl font-bold mr-5">User Email</label>
                            <input name="email" id="user_email" type="email" placeholder="User Email" className="input input-bordered w-full mt-3 focus:ring focus:ring-opacity-75 dark:text-gray-50 focus:dark:ring-violet-600 dark:border-gray-300" />
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="short_description" id="" cols="50" rows="10" type="text" placeholder="Short Description" className="input input-bordered mt-3 h-28 w-full  focus:ring focus:ring-opacity-75 dark:text-gray-50 focus:dark:ring-violet-600 dark:border-gray-300" ></textarea>

                        </div>

                        <div>
                            <label htmlFor="Detailed description" className="text-xl font-bold mr-5">Detailed Description</label>
                            <textarea name="detailed_description" id="" cols="50" rows="10" type="text" placeholder="Detailed Description" className="input input-bordered mt-3 w-full  h-28 focus:ring focus:ring-opacity-75 dark:text-gray-50 focus:dark:ring-violet-600 dark:border-gray-300" ></textarea>
                        </div>

                        <div>
                            <label htmlFor="Category" className="text-xl font-bold mr-5">Category</label>
                            {/* <select name="category" id="category" type="text" placeholder="Category" className="input input-bordered w-full mt-3 focus:ring focus:ring-opacity-75 dark:text-gray-50 focus:dark:ring-violet-600 dark:border-gray-300">
                            </select> */}
